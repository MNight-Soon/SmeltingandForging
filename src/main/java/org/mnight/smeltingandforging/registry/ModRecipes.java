...
public class ModRecipes {
    ...
    public static final Supplier<RecipeType<SmelteryRecipe>> SMELTERY_RECIPE_TYPE = RECIPE_TYPES.register("smeltery", () -> new RecipeType<SmelteryRecipe>() {
        ...
        public String toString() {
            return "smeltingandforging:smeltery";
        }
    });
    public static final Supplier<RecipeSerializer<SmelteryRecipe>> SMELTERY_SERIALIZER = RECIPE_SERIALIZER.register("smeltery", () -> SmelteryRecipe.Serializer::new);
